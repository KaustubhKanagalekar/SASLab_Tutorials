...
class ArchimedesSpiral(Node):
    ...
    def __init__(self):
        ...
        self.initial_linear_velocity = 0.2  # m/s (adjusted for simulation)
        self.initial_angular_velocity = 1.0  # rad/s (initial angular velocity)
        self.angular_velocity_decrease = 0.02  # Rate at which angular velocity decreases
        self.min_angular_velocity = 0.1  # Minimum angular velocity to avoid too slow turns
